...
export class Event extends Entity {
  ...
  get totalConfimedAttendees(): BigInt {
    let value = this.get("totalConfimedAttendees");
    return value!.toBigInt();
  }

  set totalConfimedAttendees(value: BigInt) {
    this.set("totalConfimedAttendees", Value.fromBigInt(value));
  }
